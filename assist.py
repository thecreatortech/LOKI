...
assistant = client.beta.assistants.retrieve("asst_sW9HULfHkJIkRozAiCH4u8a8")
#create empty thread
loki_thread = "thread_mAl3r4sIEdH6CrxnrBH2rh5d"
thread = client.beta.threads.retrieve(loki_thread)
...
def ask_question_standard(question):
    ...
    context = """
    You are an assistant named loki like from the ironman movies. 
...
# Try this if you want loki to remember the conversation
...
# #Delete this not necessarry
# response = ask_question_memory("Tell me Joke")
# print(response)
# TTS(response)